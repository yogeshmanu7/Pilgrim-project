    ...
    <div class="container mt-5">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h2 class="card-title mb-0">Video Call with ${scholar.user.name}</h2>
            </div>
            <div class="card-body text-center p-5">
                <c:if test="${not empty booking}">
                    <h3>Service: ${booking.serviceDescription}</h3>
                ...
                <c:if test="${not empty booking}">
                    <div class="mt-4">
                        <a href="${pageContext.request.contextPath}/customer/scholar/chat?scholarId=${scholar.id}&bookingId=${booking.id}" 
