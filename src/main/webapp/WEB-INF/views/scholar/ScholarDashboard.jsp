    ...
    <div class="scholar-theme" style="padding: 40px 0; margin-bottom: 30px;">
        <div class="container">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h1 style="color: var(--text-cream); margin: 0; font-size: 36px;">📿 Spiritual Scholar Dashboard</h1>
    ...
    <div class="container">
        ...
        <div class="card scholar-card" style="margin-bottom: 30px;">
            <div style="display: flex; align-items: center; gap: 20px;">
                ...
                <div style="flex: 1;">
                    ...
                    <p><strong>Type:</strong> <span style="color: var(--text-wine); font-weight: 600;">${scholar.type == 'ASTROLOGER' ? 'Astrologer' : 'Spiritual Scholar'}</span></p>
        ...
        <div class="card scholar-card" style="margin-bottom: 30px;">
            <div class="card-header" style="background: linear-gradient(135deg, var(--wine) 0%, var(--wine-dark) 100%); color: var(--text-cream); display: flex; justify-content: space-between; align-items: center;">
                <h2 class="card-title mb-0">My Spiritual Services</h2>
                <a href="${pageContext.request.contextPath}/scholar/service/list" class="btn btn-light btn-sm" style="background: var(--dutch-white); color: var(--text-wine); border: 1px solid var(--border-wine);">
            ...
            <div class="col-md-4">
                <div class="card scholar-card text-center">
                    <div class="card-body">
                        ...
                        <a href="${pageContext.request.contextPath}/scholar/service/list" class="btn scholar-btn">Manage Services</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
