...
<main>
    ...
    <div class="container">
        ...
        <!-- Services Section -->
        <div class="card scholar-card" style="margin-bottom: 30px;">
            <div class="card-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-4">
                <div class="card scholar-card text-center">
                    <div class="card-body">
                        <h3 style="color: #667eea;">📦 Services</h3>
